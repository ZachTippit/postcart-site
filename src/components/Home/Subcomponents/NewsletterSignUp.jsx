...
const NewsletterSignUp = () => {
    ...
    <div style={{backgroundColor: 'darkgray', padding: '2rem', height: '250px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
        <div style={{textAlign: 'center', width: '100%'}}>
            ...
            <Typography gutterBottom variant="body1" align="center" style={{fontSize: '0.75rem', paddingBottom: '2rem', marginTop: '1rem'}}>Join to get special offers, free giveaways, and once-in-a-lifetime deals.</Typography>
