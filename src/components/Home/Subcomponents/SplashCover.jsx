...
const SplashCover = () => {
    ...
    return(
        <div style={{backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.75)), url(${SplashImage})`, backgroundSize: 'cover', height: '40vh', lineHeight: '40vh'}}>
            <span style={{display: 'inline-block', verticalAlign: 'middle', lineHeight: '3rem', paddingLeft: '15%'}}>
                <Typography gutterBottom variant='h1' style={{color: 'white', fontSize: '2.5rem'}}>Cool Products!</Typography>
                <Typography gutterBottom variant='h3' style={{color: 'white', fontSize: '1rem'}}><i>Want to get some cool things?</i></Typography>
