...
const SplashCover = () => {
    ...
    return(
        <div style={{backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.75)), url(${SplashImage})`, backgroundSize: 'cover', height: '40vh', lineHeight: '40vh'}}>
            <span style={{display: 'inline-block', verticalAlign: 'middle', lineHeight: '7rem', paddingLeft: '15%', marginRight: '1rem'}}>
                <Typography gutterBottom variant='h1' style={{color: 'white', fontSize: '2rem', paddingBottom: '2rem'}}>Welcome to Postcart!</Typography>
